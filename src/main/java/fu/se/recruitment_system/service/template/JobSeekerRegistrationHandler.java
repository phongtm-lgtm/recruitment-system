...
@Component
public class JobSeekerRegistrationHandler extends AbstractUserRegistrationTemplate {

    public JobSeekerRegistrationHandler(UserRepository userRepository,
    ...
    protected void validateRoleSpecificInput(RegisterRequest request) {
        // Job seeker specific validation if needed
    }
